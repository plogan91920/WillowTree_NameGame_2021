    ...
    if (!this.state.complete) {
      ...
      return (
        <div className="Page-Play">
          ...
          <div className="Name">{this.state.question.answer ? this.state.question.answer.firstName + " " + this.state.question.answer.lastName : ""}</div>
          <div className="Portraits">
            {this.state.question.options.map((option) => (
              <EmployeePortrait result={option.answer} onClick={this.resolveAnswer} key={option.employee.id} employee={option.employee}/>
            ))}
          </div>
          <Button onClick={this.nextQuestion} disabled={!this.state.answer} text="Continue" />
        </div>
      )
    } else {
      //Render Score
        ...
        <div className="Page-Score">
          <div className="TopHalf">
            <div className="Report">
              ...
              <p>Congratulations, you scored {this.correctAnswers}/{this.questionLimit}!</p>
            </div>
          ...
          <div className="Scoring">
            <div className="Category">
              <div className="Value">{correctPercentage}%</div>
              <label>Correct Selections</label>
            </div>
            <div className="Category">
              <div className="Value">{incorrectPercentage}%</div>
              <label>Incorrect Selections</label>
            </div>
            <div className="Category">
              <div className="Value">{averageTime} sec</div>
